...
class MoonPhase
{
	...
	*/
	public function __construct($date = null)
	{
		...
		elseif ($date instanceof \DateTime) {
			//$date = date_timestamp_get($date->getTimestamp();
			$date = (float)$date->format('U');
		}
		$this->timestamp = $date;
		if($dbg){
			print "\r\n asdf ";
	...
	*/
	protected function phasehunt(): void
	{
		...
		$dtY=new \DateTime();
		$dtY = \DateTime::createFromFormat('U', $ats);
	...
	* @return float
	*/
	protected function utc_to_julian(float $timestamp): float
	{
